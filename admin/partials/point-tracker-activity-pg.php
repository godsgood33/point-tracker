...
<div id='group-msg' class='error notice' style='display:none;'>
    <p><?php print __("Please add all activities to a group, or none of them."); ?>
    </p>
</div>
...
<div id='activity'>
    <div class='onefourth'>
        <input type='text' class='act-name tooltip-field' id='act-name' maxlength='10' style='text-transform:lowercase;'
            pattern='[a-z]*' placeholder='Name...' title='Short name for the activity (max 10 characters)' /><br />

        <input type='text' class='act-ques tooltip-field' id='act-ques' placeholder='Question...'
            title='What question do you want to ask the participant' /><br />

        <input type='text' class='act-desc tooltip-field' id='act-desc' value='' placeholder='Desc...'
            title='Long description explaining any limitations, restrictions, or allowances for this activity' /><br />
    </div>

    <div class='onefourth'>
        <label for='order'>Order:</label>
        <input type='text' class='act-order tooltip-field' id='act-order' value='' placeholder='Order...'
            title='What order do you want this displayed on the page' /><br />

        <label for='pts'>Points:</label>
        <input type='text' class='act-pts tooltip-field' id='act-pts' value='0'
            title='Point value for each amount of the entry' /><br />

        <label for='chal-max'>Max Allowed:</label>
        <input type='text' class='act-chal-max tooltip-field' id='act-chal-max' value='0'
            title='Numeric value of the maximum amount points allowed during the whole challenge' /><br />
    </div>

    <div class='onefourth'>
        <input type='text' class='act-group tooltip-field' id='act-group' placeholder='Group...'
    ...
    <div class='onefourth'>
        ...
        <input type='text' class='act-label tooltip-field' id='act-labels' value='' placeholder='Label...'
            title='Comma delimited list of possible options for checkboxes and radio buttons' /><br />

        <label for='act-min'>Min:</label>
        <input type='text' class='act-min tooltip-field' id='act-min' value='0' placeholder='Min...'
        ...
        <input type='text' class='act-max tooltip-field' id='act-max' value='0' placeholder='Max...'
