...
$(".fa-trash-alt").click(function(){$.ajax(ajaxurl,{data:{"action":"delete-activity","act-id":$(this).data("id"),"security":$("#_wpnonce").val()},beforeSend:beforeAjaxSend,complete:ajaxComplete,success:function(data){if(!check_for_error(data)){return;}table1.row().remove().draw();},error:function(xhr,status,error){console.error(error);},dataType:"json",method:"post"});});$(".fa-edit").click(edit_activity);},error:function(xhr,status,error){console.error(error);},dataType:"json",method:"post"});}function save_activity(){$("#msg").removeClass("err-msg");
...
$.ajax(ajaxurl,{data:{"action":"remove-participant","chal-id":$("#challenge_participants").val(),"user-id":uid,"security":$("#_wpnonce").val()},beforeSend:beforeAjaxSend,complete:ajaxComplete,success:function(data){if(!check_for_error(data)){return;}table1.row().remove().draw();},error:function(xhr,status,error){console.error(error);},dataType:"json",method:"post"});}function clear_participants(){$.ajax(ajaxurl,{data:{action:"clear-participants","chal-id":$("#challenge_participants").val(),"security":$("#_wpnonce").val()},beforeSend:beforeAjaxSend,complete:ajaxComplete,success:function(data){if(!check_for_error(data)){return;
